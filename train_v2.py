...
if __name__ == "__main__":
    ...
    ***********************************************************************************
    ...
    train_dataset = KidneyDataset(args.data_path, train=True, transform=None)
    ...
    # style_images = next(style_iter).to(device)
        train_iter = iter(data.DataLoader(train_dataset,
                                          batch_size=args.batch_size,
                                          num_workers=args.n_threads,
                                          shuffle=True))
        # for epoch in range(args.epochs):
        # for i, style in enumerate(train_loader):
        ...
        if i % 10 == 0:
            ...
            # content_images = np.transpose(content_images,(0,2,3,1))
            # style_images = np.transpose(style_images,(0,2,3,1))
