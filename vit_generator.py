...
from torch_self.layers.transformer import (
    calc_tokenized_size, ViTInput, TransformerEncoder, img_to_tokens, img_from_tokens
)
...
if __name__ == '__main__':
    ...
    # 实例化模型， 获得模型结构，need to check
    result = ViTGenerator(features=features, n_heads=n_heads, n_blocks=n_blocks, ffn_features=ffn_features, 
                          embed_features=embed_features, activ=activ, norm=norm,
                          image_shape=image_shape, token_size=token_size)
